...
def model_joint_fn_decorator():
    ...
    def get_rcnn_loss(model, ret_dict, tb_dict):
        ...
        if fg_sum != 0:
            ...
            print(rcnn_reg.shape, fg_mask.shape)
            print(rcnn_reg.view(batch_size, -1)[fg_mask].shape)
            loss_loc, loss_angle, loss_size, reg_loss_dict = \
        ...
        rcnn_loss = rcnn_loss_cls+rcnn_loss_cls_2nd + rcnn_loss_cls_3rd+rcnn_loss_reg+rcnn_loss_reg_2nd+rcnn_loss_reg_3rd
