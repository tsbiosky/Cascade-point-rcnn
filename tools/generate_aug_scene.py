...
parser.add_argument('--save_dir', type=str, default='/home/hjx/Desktop/PointRCNN-old//data/KITTI/aug_scene/training')
...
if __name__ == '__main__':
    ...
    if args.mode == 'generator':
        ...
        dataset = AugSceneGenerator(root_dir='/home/hjx/Desktop/PointRCNN-old/data', gt_database=gt_database, split=args.split)
